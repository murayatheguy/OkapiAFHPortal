...
export function NCPPrintPreview({ formData, facility, onClose }: NCPPrintPreviewProps) {
  ...
  // Print handler - opens in a new window to isolate from dashboard
  const handlePrint = () => {
    const printContent = document.getElementById('ncp-print-content');
    ...
    const printStyles = `
      ...
      * {
      ...
      th {
        background-color: ${NCP_COLORS.sectionHeaderBg} !important;
        color: ${NCP_COLORS.sectionHeaderText} !important;
        font-weight: bold;
      }
      .section-header {
        background-color: ${NCP_COLORS.sectionHeaderBg} !important;
      ...
      .alt-row {
        background-color: ${NCP_COLORS.alternateRowBg} !important;
      }
      ...
      @media print {
        ...
        th, .section-header { background-color: ${NCP_COLORS.sectionHeaderBg} !important; color: ${NCP_COLORS.sectionHeaderText} !important; }
        .alt-row { background-color: ${NCP_COLORS.alternateRowBg} !important; }
      }
    `;
      ...
      <div className="flex-1 overflow-auto bg-gray-100 p-8">
        ...
        >
          ...
          <div className="text-center mb-4">
            ...
            <p style={{ color: NCP_COLORS.linkText, fontSize: '11pt', marginBottom: '8px' }}>
            ...
            <table style={tableStyle}>
              ...
              <tbody>
                <tr>
                  ...
                  <td style={{ ...tdStyle, width: '25%' }}>{formData.residentInfo.providerName || facility?.name || ''}</td>
                  <td style={{ ...thStyle, width: '25%' }}>NCP Start Date:</td>
                  <td style={{ ...tdStyle, width: '25%' }}>{formatDate(formData.residentInfo.ncpStartDate)}</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td style={tdStyle}>{formatDate(formData.residentInfo.dateOfBirth)}</td>
                ...
                <tr>
                  ...
                  <td style={tdStyle}>{formatDate(formData.residentInfo.movedInDate)}</td>
          ...
          <div style={{ pageBreakBefore: 'always', marginBottom: '16px' }}>
            <div style={{ fontSize: '10pt', marginBottom: '8px' }}>
              Resident's Name: <strong>{residentName}</strong>
            </div>
            <table style={tableStyle}>
              <thead>
                <tr>
              ...
              <tbody>
                ...
                {formData.emergencyContacts.contacts.length === 0 && (
                  <tr>
                    <td colSpan={4} style={tdStyle}>No emergency contacts entered</td>
                  </tr>
                )}
              </tbody>
            </table>
          ...
          <div style={{ pageBreakBefore: 'always', marginBottom: '16px' }}>
            ...
            <table style={tableStyle}>
              <thead>
                <tr>
                  <th colSpan={3} style={sectionHeaderStyle}>
                    SECTION 4: COMMUNICATION
                  </th>
                </tr>
                <tr>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td style={tdStyle}>{formData.communication.preferredLanguage || formData.residentInfo.primaryLanguage || ''}</td>
          ...
          <div style={{ pageBreakBefore: 'always', marginBottom: '16px' }}>
            ...
            <table style={tableStyle}>
              <tbody>
                <tr>
                  <td style={tdStyle}>
                    <strong>Medication Plan When Resident Away:</strong><br />
                    {formData.medication.medicationPlanWhenAway || ''}
                  </td>
                </tr>
                <tr>
                  <td style={altRowStyle}>
                    <strong>Medication Refusal Plan:</strong><br />
                    {formData.medication.medicationRefusalPlan || ''}
                  </td>
                </tr>
              </tbody>
            </table>
          ...
          <div style={{ pageBreakBefore: 'always', marginBottom: '16px' }}>
            ...
            <table style={tableStyle}>
              ...
              <tbody>
                ...
                <tr>
                  <td style={thStyle}>Strengths & Abilities:</td>
                  <td style={altRowStyle}>{formData.healthIndicators.healthMonitoringStrengths || ''}</td>
                  <td style={thStyle}>Assistance Required:</td>
                  <td style={altRowStyle}>{formData.healthIndicators.healthMonitoringAssistance || ''}</td>
                </tr>
              </tbody>
            </table>
          ...
          <div style={{ pageBreakBefore: 'always', marginBottom: '16px' }}>
            ...
            <table style={tableStyle}>
              <tbody>
                <tr>
                  <td style={tdStyle}>
                    <strong>Treatment Refusal Plan:</strong><br />
                    {formData.treatments.treatmentRefusalPlan || ''}
                  </td>
                </tr>
              </tbody>
            </table>
          ...
          <div style={{ pageBreakBefore: 'always', marginBottom: '16px' }}>
            ...
            <table style={tableStyle}>
              <tbody>
                <tr>
                  <td style={tdStyle}>
                    <strong>Other Behaviors:</strong> {formData.psychSocial.otherBehaviors || ''}
                  </td>
                </tr>
                <tr>
                  <td style={altRowStyle}>
                    <Checkbox checked={formData.psychSocial.requiresPsychMedications} /> Requires Psych Medications
                    {formData.psychSocial.requiresPsychMedications && `: ${formData.psychSocial.psychMedicationSymptoms || ''}`}
                  </td>
                </tr>
                <tr>
                  <td style={tdStyle}>
                    <Checkbox checked={formData.psychSocial.behavioralHealthCrisisPlan} /> Behavioral Health Crisis Plan
                    {' '}
                    <Checkbox checked={formData.psychSocial.counseling} /> Counseling
                    {formData.psychSocial.counseling && `: ${formData.psychSocial.mentalHealthProvider || ''}`}
                  </td>
                </tr>
                <tr>
                  <td style={altRowStyle}>
                    <strong>Past Behaviors:</strong> {formData.psychSocial.pastBehaviors || ''}
                  </td>
                </tr>
                <tr>
                  <td style={tdStyle}>
                    <strong>Typical Day Narrative:</strong><br />
                    {formData.psychSocial.typicalDayNarrative || ''}
                  </td>
                </tr>
              </tbody>
            </table>
              ...
              <tbody>
                ...
                <tr>
                  <td colSpan={3} style={tdStyle}>
                    <strong>Functional Limitations:</strong> {formData.adls.functionalLimitations || ''}
                  </td>
                </tr>
                {/* Ambulation */}
                <tr>
          ...
          <div style={{ pageBreakBefore: 'always', marginBottom: '16px' }}>
            ...
            {/* Smoking */}
            {formData.iadls.smoking.residentSmokes && (
              <table style={tableStyle}>
                <thead>
                  <tr>
                    <td colSpan={2} style={{ ...sectionHeaderStyle, backgroundColor: NCP_COLORS.alternateRowBg, color: NCP_COLORS.mainText }}>
                ...
                <tbody>
                  <tr>
                    <td style={{ ...thStyle, width: '30%' }}>Resident Smokes:</td>
                    <td style={tdStyle}><Checkbox checked={formData.iadls.smoking.residentSmokes} /> Yes</td>
                  </tr>
                  <tr>
                    <td style={thStyle}>Safety Concerns:</td>
                    <td style={altRowStyle}>{formData.iadls.smoking.safetyConcerns || ''}</td>
                  </tr>
                  <tr>
                    <td style={thStyle}>Policy Reviewed:</td>
                    <td style={tdStyle}><Checkbox checked={formData.iadls.smoking.policyReviewed} /> Yes</td>
                  </tr>
                  <tr>
                    <td style={thStyle}>Cigarette/Lighter Storage:</td>
                    <td style={altRowStyle}>{formData.iadls.smoking.cigaretteLighterStorage || ''}</td>
                  </tr>
                </tbody>
              </table>
            )}
            ...
            <table style={tableStyle}>
              <tbody>
                <tr>
                  <td style={tdStyle}>
                    <strong>Other Issues/Concerns:</strong><br />
                    {formData.iadls.otherIssuesConcerns || ''}
                  </td>
                </tr>
              </tbody>
            </table>
          ...
          <div style={{ pageBreakBefore: 'always', marginBottom: '16px' }}>
            ...
            <table style={tableStyle}>
              <tbody>
                <tr>
                  ...
                  <td style={{ ...tdStyle, width: '20%' }}>{formatDate(formData.signatures.dateOfOriginalPlan)}</td>
                ...
                <tr>
                  ...
                  <td style={altRowStyle}>
                    ...
                    {formData.signatures.ncpSentToCM && ` Date: ${formatDate(formData.signatures.ncpSentToCMDate)}`}
                  </td>
                  <td style={thStyle}>Resident Verbally Agreed:</td>
                  <td style={altRowStyle}>
                    <Checkbox checked={formData.signatures.residentVerballyAgreed} /> Yes
                    {formData.signatures.residentVerballyAgreed && ` Date: ${formatDate(formData.signatures.residentVerballyAgreedDate)}`}
                  </td>
                </tr>
              </tbody>
            </table>
            ...
            <table style={tableStyle}>
              <tbody>
                <tr>
                  <td style={tdStyle}>
                    <strong>Resident Recommendations:</strong><br />
                    {formData.signatures.residentRecommendations || ''}
                  </td>
                </tr>
              </tbody>
            </table>
